...
export default function AchievementPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 p-4 flex items-center justify-center relative overflow-hidden">
      ...
      {/* Main content */}
      <div className={`max-w-lg w-full transition-all duration-500 ${showAnimation ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
